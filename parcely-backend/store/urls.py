...
urlpatterns = [
    ...
    # page related urls
    path('<str:storefront_slug>/pages/', PageListAPIView.as_view(), name='list-pages'),
    ...
    path('<str:storefront_slug>/pages/<str:page_slug>/blocks/batch/', PageBlockBatchAPIView.as_view(), name='page-block-batch'),
